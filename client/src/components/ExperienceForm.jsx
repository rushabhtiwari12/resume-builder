                    ...
                    <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                        ...
                        <div className='space-y-2'>
                            <div className='flex items-center'>
                                ...
                                <button className='flex items-center gap-1 px-2 py-1 text-xs ng-purple-100 text-purple-700 rounded hover:bg-purple-200 transition-colors disabled:opacity-50'>
